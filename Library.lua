...
do
    ...
    Library:AddToRegistry(PlayersAccent, {
        BackgroundColor3 = 'AccentColor';
    }, true);

    local PlayersTitle = Library:CreateLabel({
        Size = UDim2.new(1, 0, 0, 20);
        Position = UDim2.fromOffset(5, 2);
        TextXAlignment = Enum.TextXAlignment.Left;
        Text = 'Players';
    ...
    local function createPlayerRow(player)
        ...
        row.InputBegan:Connect(function(Input)
            ...
            local nextRel =
                (current == "Neutral" and "Friendly")
                or (current == "Friendly" and "Enemy")
                or "Neutral"
...
function Library:CreateWindow(...)
    ...
    function Library:Toggle()
        ...
        if Library.PlayersFrame then
            ...
            for _, Desc in next, Library.PlayersFrame:GetDescendants() do
                local Properties = {};
